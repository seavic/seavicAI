...
const prohibited = [
  ...
  /\bmid-market\b/i,
  /\bSeaVic Consulting LLC\b/i,
  /Discuss Your Enterprise AI Priorities/i,
  /Assess Your AI Operating Readiness/i,
  /disabled until the provider and privacy treatment/i,
  /Control Readiness Check/i,
  /five[-\s]capability/i,
  /source-visible/i,
  /siehlui-seavic\.github\.io/i,
  /Frutiger/i,
  /Webflow/i,
  /Squarespace/i,
  /WordPress/i
