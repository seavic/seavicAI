...
Current review state as of 2026-07-22:

- Temporary GitHub Pages review deployment is live at `https://staging.seavicai.com/`.
- Build A and Build B use the approved original homepage content mapped into two WordPress-portable template directions.
